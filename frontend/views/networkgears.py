...
from frontend.forms import NetworkGearForm as ahomeForm

API_NAME = 'networkgears'
MODEL_NAME = 'NetworkGear'
MODEL_OBJ = NetworkGear
...
def networkgears_create(request):
...
def networkgears_update(request, pk):
...
def networkgears_delete(request, pk):
