...
from frontend.forms import MonitoringForm as ahomeForm
...
API_NAME = 'monitorings'
MODEL_NAME = 'Monitoring'
MODEL_OBJ = Monitoring
...
def monitorings_create(request):
...
def monitorings_update(request, pk):
...
def monitorings_delete(request, pk):
...
@login_required
def monitorings_wizardbox_create(request):
