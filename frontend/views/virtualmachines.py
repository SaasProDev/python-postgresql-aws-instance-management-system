...
from .functions import OPS, get_apidata, save_form, get_detail_apidata

from frontend.forms import VirtualMachineForm as ahomeForm

# from .database_dict import DICT_CREDENTIALS
from core.utils import DICT_CREDENTIALS


API_NAME = 'virtualmachines'
MODEL_NAME = 'VirtualMachine'
MODEL_OBJ = VirtualMachine
...
def virtualmachines_list(request):
...
def virtualmachines_create(request):
...
def virtualmachines_update(request, pk):
...
def virtualmachines_delete(request, pk):
...
def virtualmachines_detail(request, pk):


    # apidata = get_apidata(API_NAME, request)
    apidata = get_detail_apidata(API_NAME, pk, request)
