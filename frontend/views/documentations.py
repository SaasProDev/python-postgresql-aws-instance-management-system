...
from frontend.forms import DocumentationForm as ahomeForm

API_NAME = 'documentations'
MODEL_NAME = 'Documentation'
MODEL_OBJ = Documentation
...
def documentations_list(request):
...
def documentations_create(request):
...
def documentations_update(request, pk):
...
def documentations_delete(request, pk):
