...
from frontend.forms import UserCredentialForm as ahomeForm

from core.utils import DICT_CREDENTIALS


API_NAME = 'usercredentials'
MODEL_NAME = 'UserCredential'
MODEL_OBJ = UserCredential
...
def usercredentials_list(request):
...
def usercredentials_update(request, pk):
...
def usercredentials_credential(request, pk):
...
def usercredentials_delete(request, pk):
